...
export default function Forecast2() {
  const { items, chartData, hotspots, isLive, lastUpdated, activeSource } = useForecastData(2);
  ...
  return (
    <PageSection id="forecast-2" rightPanel={<MapPanel hotspots={hotspots} alt="Delhi NCR hotspot map" />}>
      <DashboardHeader
        title="Forecast (48h)"
        dateRange={dateRange}
      />
      ...
      <section style={{ marginTop: 'var(--space-6)' }}>
        <div style={sectionTitleStyle}>
          <span>Prediction Map Day 2</span>
          {isLive && (
